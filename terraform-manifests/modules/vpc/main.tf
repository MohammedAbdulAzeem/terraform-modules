...
# create public subnet az4
resource "aws_subnet" "public_subnet_az4" {
  vpc_id                  = aws_vpc.vpc.id
  cidr_block              = var.public_subnet_az4_cidr
...
# associate public subnet az4 to "public route table"
resource "aws_route_table_association" "public_subnet_az4_route_table_association" {
  subnet_id           = aws_subnet.public_subnet_az4.id
  route_table_id      = aws_route_table.public_route_table.id
}
